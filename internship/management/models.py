...
class CompanySupervisorFeedbackForm(models.Model):
 ...
 Understanding_fundamentals=models.IntegerField()
 Problem_designing=models.IntegerField()
 Technical_Knowledge=models.IntegerField()
 Managerial_skill=models.IntegerField()
 Tool_selection=models.IntegerField()
 Data_handling=models.IntegerField()
 Work_ethics=models.IntegerField()
 Communication_practices=models.IntegerField()
 Performance=models.IntegerField()
 Innovative_approach=models.IntegerField()
 Learning_capability=models.IntegerField()
 Apply_Reasoning=models.IntegerField()
 Understand_impact=models.IntegerField()
